...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Ho(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ja(),fragmentShader:`
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Go(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ja(),fragmentShader:`
...
}`;function ym(i,e,t){let n=new Za;const s=new Fe,r=new Fe,a=new ut,o=new vm({depthPacking:dh}),l=new xm,c={},h=t.maxTextureSize,f={[In]:Ct,[Ct]:In,[dn]:dn},m=new Nn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Fe},radius:{value:4}},vertexShader:Mm,fragmentShader:Sm}),p=m.clone();p.defines.HORIZONTAL_PASS=1;const _=new Ot;_.setAttribute("position",new nn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Gt(_,m),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ol;let u=this.type;this.render=function(L,w,F){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||L.length===0)return;const ee=i.getRenderTarget(),g=i.getActiveCubeFace(),S=i.getActiveMipmapLevel(),W=i.state;W.setBlending(Ln),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const V=u!==un&&this.type===un,J=u===un&&this.type!==un;for(let te=0,X=L.length;te<X;te++){const ne=L[te],Y=ne.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",ne,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;s.copy(Y.mapSize);const _e=Y.getFrameExtents();if(s.multiply(_e),r.copy(Y.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/_e.x),s.x=r.x*_e.x,Y.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/_e.y),s.y=r.y*_e.y,Y.mapSize.y=r.y)),Y.map===null||V===!0||J===!0){const de=this.type!==un?{minFilter:Ht,magFilter:Ht}:{};Y.map!==null&&Y.map.dispose(),Y.map=new Kn(s.x,s.y,de),Y.map.texture.name=ne.name+".shadowMap",Y.camera.updateProjectionMatrix()}i.setRenderTarget(Y.map),i.clear();const ue=Y.getViewportCount();for(let de=0;de<ue;de++){const Ge=Y.getViewport(de);a.set(r.x*Ge.x,r.y*Ge.y,r.x*Ge.z,r.y*Ge.w),W.viewport(a),Y.updateMatrices(ne,de),n=Y.getFrustum(),T(w,F,Y.camera,ne,this.type)}Y.isPointLightShadow!==!0&&this.type===un&&E(Y,F),Y.needsUpdate=!1}u=this.type,d.needsUpdate=!1,i.setRenderTarget(ee,g,S)};function E(L,w){const F=e.update(M);m.defines.VSM_SAMPLES!==L.blurSamples&&(m.defines.VSM_SAMPLES=L.blurSamples,p.defines.VSM_SAMPLES=L.blurSamples,m.needsUpdate=!0,p.needsUpdate=!0),L.mapPass===null&&(L.mapPass=new Kn(s.x,s.y)),m.uniforms.shadow_pass.value=L.map.texture,m.uniforms.resolution.value=L.mapSize,m.uniforms.radius.value=L.radius,i.setRenderTarget(L.mapPass),i.clear(),i.renderBufferDirect(w,null,F,m,M,null),p.uniforms.shadow_pass.value=L.mapPass.texture,p.uniforms.resolution.value=L.mapSize,p.uniforms.radius.value=L.radius,i.setRenderTarget(L.map),i.clear(),i.renderBufferDirect(w,null,F,p,M,null)}function y(L,w,F,ee){let g=null;const S=F.isPointLight===!0?L.customDistanceMaterial:L.customDepthMaterial;if(S!==void 0)g=S;else if(g=F.isPointLight===!0?l:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const W=g.uuid,V=w.uuid;let J=c[W];J===void 0&&(J={},c[W]=J);let te=J[V];te===void 0&&(te=g.clone(),J[V]=te,w.addEventListener("dispose",B)),g=te}if(g.visible=w.visible,g.wireframe=w.wireframe,ee===un?g.side=w.shadowSide!==null?w.shadowSide:w.side:g.side=w.shadowSide!==null?w.shadowSide:f[w.side],g.alphaMap=w.alphaMap,g.alphaTest=w.alphaTest,g.map=w.map,g.clipShadows=w.clipShadows,g.clippingPlanes=w.clippingPlanes,g.clipIntersection=w.clipIntersection,g.displacementMap=w.displacementMap,g.displacementScale=w.displacementScale,g.displacementBias=w.displacementBias,g.wireframeLinewidth=w.wireframeLinewidth,g.linewidth=w.linewidth,F.isPointLight===!0&&g.isMeshDistanceMaterial===!0){const W=i.properties.get(g);W.light=F}return g}function T(L,w,F,ee,g){if(L.visible===!1)return;if(L.layers.test(w.layers)&&(L.isMesh||L.isLine||L.isPoints)&&(L.castShadow||L.receiveShadow&&g===un)&&(!L.frustumCulled||n.intersectsObject(L))){L.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,L.matrixWorld);const V=e.update(L),J=L.material;if(Array.isArray(J)){const te=V.groups;for(let X=0,ne=te.length;X<ne;X++){const Y=te[X],_e=J[Y.materialIndex];if(_e&&_e.visible){const ue=y(L,_e,ee,g);L.onBeforeShadow(i,L,w,F,V,ue,Y),i.renderBufferDirect(F,null,V,ue,L,Y),L.onAfterShadow(i,L,w,F,V,ue,Y)}}}else if(J.visible){const te=y(L,J,ee,g);L.onBeforeShadow(i,L,w,F,V,te,null),i.renderBufferDirect(F,null,V,te,L,null),L.onAfterShadow(i,L,w,F,V,te,null)}}const W=L.children;for(let V=0,J=W.length;V<J;V++)T(W[V],w,F,ee,g)}function B(L){L.target.removeEventListener("dispose",B);for(const F in c){const ee=c[F],g=L.target.uuid;g in ee&&(ee[g].dispose(),delete ee[g])}}}const Em={[Qr]:ea,[ta]:sa,[na]:ra,[Ti]:ia,[ea]:Qr,[sa]:ta,[ra]:na,[ia]:Ti};function bm(i){function e(){let D=!1;const pe=new ut;let H=null;const Q=new ut(0,0,0,0);return{setMask:function(fe){H!==fe&&!D&&(i.colorMask(fe,fe,fe,fe),H=fe)},setLocked:function(fe){D=fe},setClear:function(fe,ge,Ze,ct,pt){pt===!0&&(fe*=ct,ge*=ct,Ze*=ct),pe.set(fe,ge,Ze,ct),Q.equals(pe)===!1&&(i.clearColor(fe,ge,Ze,ct),Q.copy(pe))},reset:function(){D=!1,H=null,Q.set(-1,0,0,0)}}}function t(){let D=!1,pe=!1,H=null,Q=null,fe=null;return{setReversed:function(ge){pe=ge},setTest:function(ge){ge?be(i.DEPTH_TEST):ye(i.DEPTH_TEST)},setMask:function(ge){H!==ge&&!D&&(i.depthMask(ge),H=ge)},setFunc:function(ge){if(pe&&(ge=Em[ge]),Q!==ge){switch(ge){case Qr:i.depthFunc(i.NEVER);break;case ea:i.depthFunc(i.ALWAYS);break;case ta:i.depthFunc(i.LESS);break;case Ti:i.depthFunc(i.LEQUAL);break;case na:i.depthFunc(i.EQUAL);break;case ia:i.depthFunc(i.GEQUAL);break;case sa:i.depthFunc(i.GREATER);break;case ra:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Q=ge}},setLocked:function(ge){D=ge},setClear:function(ge){fe!==ge&&(i.clearDepth(ge),fe=ge)},reset:function(){D=!1,H=null,Q=null,fe=null}}}function n(){let D=!1,pe=null,H=null,Q=null,fe=null,ge=null,Ze=null,ct=null,pt=null;return{setTest:function(Je){D||(Je?be(i.STENCIL_TEST):ye(i.STENCIL_TEST))},setMask:function(Je){pe!==Je&&!D&&(i.stencilMask(Je),pe=Je)},setFunc:function(Je,St,Wt){(H!==Je||Q!==St||fe!==Wt)&&(i.stencilFunc(Je,St,Wt),H=Je,Q=St,fe=Wt)},setOp:function(Je,St,Wt){(ge!==Je||Ze!==St||ct!==Wt)&&(i.stencilOp(Je,St,Wt),ge=Je,Ze=St,ct=Wt)},setLocked:function(Je){D=Je},setClear:function(Je){pt!==Je&&(i.clearStencil(Je),pt=Je)},reset:function(){D=!1,pe=null,H=null,Q=null,fe=null,ge=null,Ze=null,ct=null,pt=null}}}const s=new e,r=new t,a=new n,o=new WeakMap,l=new WeakMap;let c={},h={},f=new WeakMap,m=[],p=null,_=!1,M=null,d=null,u=null,E=null,y=null,T=null,B=null,L=new je(0,0,0),w=0,F=!1,ee=null,g=null,S=null,W=null,V=null;const J=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let te=!1,X=0;const ne=i.getParameter(i.VERSION);ne.indexOf("WebGL")!==-1?(X=parseFloat(/^WebGL (\d)/.exec(ne)[1]),te=X>=1):ne.indexOf("OpenGL ES")!==-1&&(X=parseFloat(/^OpenGL ES (\d)/.exec(ne)[1]),te=X>=2);let Y=null,_e={};const ue=i.getParameter(i.SCISSOR_BOX),de=i.getParameter(i.VIEWPORT),Ge=new ut().fromArray(ue),Ke=new ut().fromArray(de);function K(D,pe,H,Q){const fe=new Uint8Array(4),ge=i.createTexture();i.bindTexture(D,ge),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ze=0;Ze<H;Ze++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(pe,0,i.RGBA,1,1,Q,0,i.RGBA,i.UNSIGNED_BYTE,fe):i.texImage2D(pe+Ze,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,fe);return ge}const ae={};ae[i.TEXTURE_2D]=K(i.TEXTURE_2D,i.TEXTURE_2D,1),ae[i.TEXTURE_CUBE_MAP]=K(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ae[i.TEXTURE_2D_ARRAY]=K(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ae[i.TEXTURE_3D]=K(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),a.setClear(0),be(i.DEPTH_TEST),r.setFunc(Ti),We(!1),$e(uo),be(i.CULL_FACE),P(Ln);function be(D){c[D]!==!0&&(i.enable(D),c[D]=!0)}function ye(D){c[D]!==!1&&(i.disable(D),c[D]=!1)}function Be(D,pe){return h[D]!==pe?(i.bindFramebuffer(D,pe),h[D]=pe,D===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=pe),D===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=pe),!0):!1}function Pe(D,pe){let H=m,Q=!1;if(D){H=f.get(pe),H===void 0&&(H=[],f.set(pe,H));const fe=D.textures;if(H.length!==fe.length||H[0]!==i.COLOR_ATTACHMENT0){for(let ge=0,Ze=fe.length;ge<Ze;ge++)H[ge]=i.COLOR_ATTACHMENT0+ge;H.length=fe.length,Q=!0}}else H[0]!==i.BACK&&(H[0]=i.BACK,Q=!0);Q&&i.drawBuffers(H)}function Xe(D){return p!==D?(i.useProgram(D),p=D,!0):!1}const Qe={[Wn]:i.FUNC_ADD,[Bc]:i.FUNC_SUBTRACT,[zc]:i.FUNC_REVERSE_SUBTRACT};Qe[kc]=i.MIN,Qe[Hc]=i.MAX;const Ve={[Gc]:i.ZERO,[Vc]:i.ONE,[Wc]:i.SRC_COLOR,[Zr]:i.SRC_ALPHA,[$c]:i.SRC_ALPHA_SATURATE,[jc]:i.DST_COLOR,[Yc]:i.DST_ALPHA,[Xc]:i.ONE_MINUS_SRC_COLOR,[Jr]:i.ONE_MINUS_SRC_ALPHA,[Kc]:i.ONE_MINUS_DST_COLOR,[qc]:i.ONE_MINUS_DST_ALPHA,[Zc]:i.CONSTANT_COLOR,[Jc]:i.ONE_MINUS_CONSTANT_COLOR,[Qc]:i.CONSTANT_ALPHA,[eh]:i.ONE_MINUS_CONSTANT_ALPHA};function P(D,pe,H,Q,fe,ge,Ze,ct,pt,Je){if(D===Ln){_===!0&&(ye(i.BLEND),_=!1);return}if(_===!1&&(be(i.BLEND),_=!0),D!==Oc){if(D!==M||Je!==F){if((d!==Wn||y!==Wn)&&(i.blendEquation(i.FUNC_ADD),d=Wn,y=Wn),Je)switch(D){case Mi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case fo:i.blendFunc(i.ONE,i.ONE);break;case po:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case mo:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case Mi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case fo:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case po:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case mo:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}u=null,E=null,T=null,B=null,L.set(0,0,0),w=0,M=D,F=Je}return}fe=fe||pe,ge=ge||H,Ze=Ze||Q,(pe!==d||fe!==y)&&(i.blendEquationSeparate(Qe[pe],Qe[fe]),d=pe,y=fe),(H!==u||Q!==E||ge!==T||Ze!==B)&&(i.blendFuncSeparate(Ve[H],Ve[Q],Ve[ge],Ve[Ze]),u=H,E=Q,T=ge,B=Ze),(ct.equals(L)===!1||pt!==w)&&(i.blendColor(ct.r,ct.g,ct.b,pt),L.copy(ct),w=pt),M=D,F=!1}function bt(D,pe){D.side===dn?ye(i.CULL_FACE):be(i.CULL_FACE);let H=D.side===Ct;pe&&(H=!H),We(H),D.blending===Mi&&D.transparent===!1?P(Ln):P(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),r.setFunc(D.depthFunc),r.setTest(D.depthTest),r.setMask(D.depthWrite),s.setMask(D.colorWrite);const Q=D.stencilWrite;a.setTest(Q),Q&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),Ye(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?be(i.SAMPLE_ALPHA_TO_COVERAGE):ye(i.SAMPLE_ALPHA_TO_COVERAGE)}function We(D){ee!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),ee=D)}function $e(D){D!==Nc?(be(i.CULL_FACE),D!==g&&(D===uo?i.cullFace(i.BACK):D===Uc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ye(i.CULL_FACE),g=D}function Ne(D){D!==S&&(te&&i.lineWidth(D),S=D)}function Ye(D,pe,H){D?(be(i.POLYGON_OFFSET_FILL),(W!==pe||V!==H)&&(i.polygonOffset(pe,H),W=pe,V=H)):ye(i.POLYGON_OFFSET_FILL)}function Ue(D){D?be(i.SCISSOR_TEST):ye(i.SCISSOR_TEST)}function b(D){D===void 0&&(D=i.TEXTURE0+J-1),Y!==D&&(i.activeTexture(D),Y=D)}function x(D,pe,H){H===void 0&&(Y===null?H=i.TEXTURE0+J-1:H=Y);let Q=_e[H];Q===void 0&&(Q={type:void 0,texture:void 0},_e[H]=Q),(Q.type!==D||Q.texture!==pe)&&(Y!==H&&(i.activeTexture(H),Y=H),i.bindTexture(D,pe||ae[D]),Q.type=D,Q.texture=pe)}function k(){const D=_e[Y];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function $(){try{i.compressedTexImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ie(){try{i.compressedTexImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function j(){try{i.texSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Te(){try{i.texSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function oe(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function xe(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ze(){try{i.texStorage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function re(){try{i.texStorage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function he(){try{i.texImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Re(){try{i.texImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Le(D){Ge.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),Ge.copy(D))}function Me(D){Ke.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),Ke.copy(D))}function qe(D,pe){let H=l.get(pe);H===void 0&&(H=new WeakMap,l.set(pe,H));let Q=H.get(D);Q===void 0&&(Q=i.getUniformBlockIndex(pe,D.name),H.set(D,Q))}function Oe(D,pe){const Q=l.get(pe).get(D);o.get(pe)!==Q&&(i.uniformBlockBinding(pe,Q,D.__bindingPointIndex),o.set(pe,Q))}function it(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},Y=null,_e={},h={},f=new WeakMap,m=[],p=null,_=!1,M=null,d=null,u=null,E=null,y=null,T=null,B=null,L=new je(0,0,0),w=0,F=!1,ee=null,g=null,S=null,W=null,V=null,Ge.set(0,0,i.canvas.width,i.canvas.height),Ke.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),a.reset()}return{buffers:{color:s,depth:r,stencil:a},enable:be,disable:ye,bindFramebuffer:Be,drawBuffers:Pe,useProgram:Xe,setBlending:P,setMaterial:bt,setFlipSided:We,setCullFace:$e,setLineWidth:Ne,setPolygonOffset:Ye,setScissorTest:Ue,activeTexture:b,bindTexture:x,unbindTexture:k,compressedTexImage2D:$,compressedTexImage3D:ie,texImage2D:he,texImage3D:Re,updateUBOMapping:qe,uniformBlockBinding:Oe,texStorage2D:ze,texStorage3D:re,texSubImage2D:j,texSubImage3D:Te,compressedTexSubImage2D:oe,compressedTexSubImage3D:xe,scissor:Le,viewport:Me,reset:it}}function rl(i,e,t,n){const s=Tm(n);switch(t){case Vl:return i*e;case Xl:return i*e;case Yl:return i*e*2;case ql:return i*e/s.components*s.byteLength;case Xa:return i*e/s.components*s.byteLength;case jl:return i*e*2/s.components*s.byteLength;case Ya:return i*e*2/s.components*s.byteLength;case Wl:return i*e*3/s.components*s.byteLength;case Zt:return i*e*4/s.components*s.byteLength;case qa:return i*e*4/s.components*s.byteLength;case Ls:case Ds:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Is:case Ns:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case ua:case fa:return Math.max(i,16)*Math.max(e,8)/4;case ha:case da:return Math.max(i,8)*Math.max(e,8)/2;case pa:case ma:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case _a:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case ga:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case va:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case xa:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Ma:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case Sa:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case ya:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case Ea:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case ba:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Ta:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case Aa:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case wa:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case Ra:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Ca:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case Pa:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Us:case La:case Da:return Math.ceil(i/4)*Math.ceil(e/4)*16;case Kl:case Ia:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Na:case Ua:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Tm(i){switch(i){case _n:case kl:return{byteLength:1,components:1};case ji:case Hl:case Ki:return{byteLength:2,components:1};case Va:case Wa:return{byteLength:2,components:4};case jn:case Ga:case fn:return{byteLength:4,components:1};case Gl:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Am(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Fe,h=new WeakMap;let f;const m=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(b,x){return p?new OffscreenCanvas(b,x):Xs("canvas")}function M(b,x,k){let $=1;const ie=Ue(b);if((ie.width>k||ie.height>k)&&($=k/Math.max(ie.width,ie.height)),$<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const j=Math.floor($*ie.width),Te=Math.floor($*ie.height);f===void 0&&(f=_(j,Te));const oe=x?_(j,Te):f;return oe.width=j,oe.height=Te,oe.getContext("2d").drawImage(b,0,0,j,Te),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ie.width+"x"+ie.height+") to ("+j+"x"+Te+")."),oe}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ie.width+"x"+ie.height+")."),b;return b}function d(b){return b.generateMipmaps&&b.minFilter!==Ht&&b.minFilter!==Kt}function u(b){i.generateMipmap(b)}function E(b,x,k,$,ie=!1){if(b!==null){if(i[b]!==void 0)return i[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let j=x;if(x===i.RED&&(k===i.FLOAT&&(j=i.R32F),k===i.HALF_FLOAT&&(j=i.R16F),k===i.UNSIGNED_BYTE&&(j=i.R8)),x===i.RED_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.R8UI),k===i.UNSIGNED_SHORT&&(j=i.R16UI),k===i.UNSIGNED_INT&&(j=i.R32UI),k===i.BYTE&&(j=i.R8I),k===i.SHORT&&(j=i.R16I),k===i.INT&&(j=i.R32I)),x===i.RG&&(k===i.FLOAT&&(j=i.RG32F),k===i.HALF_FLOAT&&(j=i.RG16F),k===i.UNSIGNED_BYTE&&(j=i.RG8)),x===i.RG_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.RG8UI),k===i.UNSIGNED_SHORT&&(j=i.RG16UI),k===i.UNSIGNED_INT&&(j=i.RG32UI),k===i.BYTE&&(j=i.RG8I),k===i.SHORT&&(j=i.RG16I),k===i.INT&&(j=i.RG32I)),x===i.RGB_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.RGB8UI),k===i.UNSIGNED_SHORT&&(j=i.RGB16UI),k===i.UNSIGNED_INT&&(j=i.RGB32UI),k===i.BYTE&&(j=i.RGB8I),k===i.SHORT&&(j=i.RGB16I),k===i.INT&&(j=i.RGB32I)),x===i.RGBA_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),k===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),k===i.UNSIGNED_INT&&(j=i.RGBA32UI),k===i.BYTE&&(j=i.RGBA8I),k===i.SHORT&&(j=i.RGBA16I),k===i.INT&&(j=i.RGBA32I)),x===i.RGB&&k===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),x===i.RGBA){const Te=ie?Hs:nt.getTransfer($);k===i.FLOAT&&(j=i.RGBA32F),k===i.HALF_FLOAT&&(j=i.RGBA16F),k===i.UNSIGNED_BYTE&&(j=Te===lt?i.SRGB8_ALPHA8:i.RGBA8),k===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),k===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function y(b,x){let k;return b?x===null||x===jn||x===Ri?k=i.DEPTH24_STENCIL8:x===fn?k=i.DEPTH32F_STENCIL8:x===ji&&(k=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===jn||x===Ri?k=i.DEPTH_COMPONENT24:x===fn?k=i.DEPTH_COMPONENT32F:x===ji&&(k=i.DEPTH_COMPONENT16),k}function T(b,x){return d(b)===!0||b.isFramebufferTexture&&b.minFilter!==Ht&&b.minFilter!==Kt?Math.log2(Math.max(x.width,x.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?x.mipmaps.length:1}function B(b){const x=b.target;x.removeEventListener("dispose",B),w(x),x.isVideoTexture&&h.delete(x)}function L(b){const x=b.target;x.removeEventListener("dispose",L),ee(x)}function w(b){const x=n.get(b);if(x.__webglInit===void 0)return;const k=b.source,$=m.get(k);if($){const ie=$[x.__cacheKey];ie.usedTimes--,ie.usedTimes===0&&F(b),Object.keys($).length===0&&m.delete(k)}n.remove(b)}function F(b){const x=n.get(b);i.deleteTexture(x.__webglTexture);const k=b.source,$=m.get(k);delete $[x.__cacheKey],a.memory.textures--}function ee(b){const x=n.get(b);if(b.depthTexture&&b.depthTexture.dispose(),b.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(x.__webglFramebuffer[$]))for(let ie=0;ie<x.__webglFramebuffer[$].length;ie++)i.deleteFramebuffer(x.__webglFramebuffer[$][ie]);else i.deleteFramebuffer(x.__webglFramebuffer[$]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[$])}else{if(Array.isArray(x.__webglFramebuffer))for(let $=0;$<x.__webglFramebuffer.length;$++)i.deleteFramebuffer(x.__webglFramebuffer[$]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let $=0;$<x.__webglColorRenderbuffer.length;$++)x.__webglColorRenderbuffer[$]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[$]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const k=b.textures;for(let $=0,ie=k.length;$<ie;$++){const j=n.get(k[$]);j.__webglTexture&&(i.deleteTexture(j.__webglTexture),a.memory.textures--),n.remove(k[$])}n.remove(b)}let g=0;function S(){g=0}function W(){const b=g;return b>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+s.maxTextures),g+=1,b}function V(b){const x=[];return x.push(b.wrapS),x.push(b.wrapT),x.push(b.wrapR||0),x.push(b.magFilter),x.push(b.minFilter),x.push(b.anisotropy),x.push(b.internalFormat),x.push(b.format),x.push(b.type),x.push(b.generateMipmaps),x.push(b.premultiplyAlpha),x.push(b.flipY),x.push(b.unpackAlignment),x.push(b.colorSpace),x.join()}function J(b,x){const k=n.get(b);if(b.isVideoTexture&&Ne(b),b.isRenderTargetTexture===!1&&b.version>0&&k.__version!==b.version){const $=b.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ke(k,b,x);return}}t.bindTexture(i.TEXTURE_2D,k.__webglTexture,i.TEXTURE0+x)}function te(b,x){const k=n.get(b);if(b.version>0&&k.__version!==b.version){Ke(k,b,x);return}t.bindTexture(i.TEXTURE_2D_ARRAY,k.__webglTexture,i.TEXTURE0+x)}function X(b,x){const k=n.get(b);if(b.version>0&&k.__version!==b.version){Ke(k,b,x);return}t.bindTexture(i.TEXTURE_3D,k.__webglTexture,i.TEXTURE0+x)}function ne(b,x){const k=n.get(b);if(b.version>0&&k.__version!==b.version){K(k,b,x);return}t.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture,i.TEXTURE0+x)}const Y={[la]:i.REPEAT,[Yn]:i.CLAMP_TO_EDGE,[ca]:i.MIRRORED_REPEAT},_e={[Ht]:i.NEAREST,[hh]:i.NEAREST_MIPMAP_NEAREST,[ss]:i.NEAREST_MIPMAP_LINEAR,[Kt]:i.LINEAR,[fr]:i.LINEAR_MIPMAP_NEAREST,[qn]:i.LINEAR_MIPMAP_LINEAR},ue={[ph]:i.NEVER,[Mh]:i.ALWAYS,[mh]:i.LESS,[Zl]:i.LEQUAL,[_h]:i.EQUAL,[xh]:i.GEQUAL,[gh]:i.GREATER,[vh]:i.NOTEQUAL};function de(b,x){if(x.type===fn&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===Kt||x.magFilter===fr||x.magFilter===ss||x.magFilter===qn||x.minFilter===Kt||x.minFilter===fr||x.minFilter===ss||x.minFilter===qn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,Y[x.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,Y[x.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,Y[x.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,_e[x.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,_e[x.minFilter]),x.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,ue[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Ht||x.minFilter!==ss&&x.minFilter!==qn||x.type===fn&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const k=e.get("EXT_texture_filter_anisotropic");i.texParameterf(b,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function Ge(b,x){let k=!1;b.__webglInit===void 0&&(b.__webglInit=!0,x.addEventListener("dispose",B));const $=x.source;let ie=m.get($);ie===void 0&&(ie={},m.set($,ie));const j=V(x);if(j!==b.__cacheKey){ie[j]===void 0&&(ie[j]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,k=!0),ie[j].usedTimes++;const Te=ie[b.__cacheKey];Te!==void 0&&(ie[b.__cacheKey].usedTimes--,Te.usedTimes===0&&F(x)),b.__cacheKey=j,b.__webglTexture=ie[j].texture}return k}function Ke(b,x,k){let $=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&($=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&($=i.TEXTURE_3D);const ie=Ge(b,x),j=x.source;t.bindTexture($,b.__webglTexture,i.TEXTURE0+k);const Te=n.get(j);if(j.version!==Te.__version||ie===!0){t.activeTexture(i.TEXTURE0+k);const oe=nt.getPrimaries(nt.workingColorSpace),xe=x.colorSpace===wn?null:nt.getPrimaries(x.colorSpace),ze=x.colorSpace===wn||oe===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ze);let re=M(x.image,!1,s.maxTextureSize);re=Ye(x,re);const he=r.convert(x.format,x.colorSpace),Re=r.convert(x.type);let Le=E(x.internalFormat,he,Re,x.colorSpace,x.isVideoTexture);de($,x);let Me;const qe=x.mipmaps,Oe=x.isVideoTexture!==!0,it=Te.__version===void 0||ie===!0,D=j.dataReady,pe=T(x,re);if(x.isDepthTexture)Le=y(x.format===Ci,x.type),it&&(Oe?t.texStorage2D(i.TEXTURE_2D,1,Le,re.width,re.height):t.texImage2D(i.TEXTURE_2D,0,Le,re.width,re.height,0,he,Re,null));else if(x.isDataTexture)if(qe.length>0){Oe&&it&&t.texStorage2D(i.TEXTURE_2D,pe,Le,qe[0].width,qe[0].height);for(let H=0,Q=qe.length;H<Q;H++)Me=qe[H],Oe?D&&t.texSubImage2D(i.TEXTURE_2D,H,0,0,Me.width,Me.height,he,Re,Me.data):t.texImage2D(i.TEXTURE_2D,H,Le,Me.width,Me.height,0,he,Re,Me.data);x.generateMipmaps=!1}else Oe?(it&&t.texStorage2D(i.TEXTURE_2D,pe,Le,re.width,re.height),D&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,re.width,re.height,he,Re,re.data)):t.texImage2D(i.TEXTURE_2D,0,Le,re.width,re.height,0,he,Re,re.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Oe&&it&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,Le,qe[0].width,qe[0].height,re.depth);for(let H=0,Q=qe.length;H<Q;H++)if(Me=qe[H],x.format!==Zt)if(he!==null)if(Oe){if(D)if(x.layerUpdates.size>0){const fe=rl(Me.width,Me.height,x.format,x.type);for(const ge of x.layerUpdates){const Ze=Me.data.subarray(ge*fe/Me.data.BYTES_PER_ELEMENT,(ge+1)*fe/Me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,ge,Me.width,Me.height,1,he,Ze,0,0)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,Me.width,Me.height,re.depth,he,Me.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,H,Le,Me.width,Me.height,re.depth,0,Me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?D&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,Me.width,Me.height,re.depth,he,Re,Me.data):t.texImage3D(i.TEXTURE_2D_ARRAY,H,Le,Me.width,Me.height,re.depth,0,he,Re,Me.data)}else{Oe&&it&&t.texStorage2D(i.TEXTURE_2D,pe,Le,qe[0].width,qe[0].height);for(let H=0,Q=qe.length;H<Q;H++)Me=qe[H],x.format!==Zt?he!==null?Oe?D&&t.compressedTexSubImage2D(i.TEXTURE_2D,H,0,0,Me.width,Me.height,he,Me.data):t.compressedTexImage2D(i.TEXTURE_2D,H,Le,Me.width,Me.height,0,Me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?D&&t.texSubImage2D(i.TEXTURE_2D,H,0,0,Me.width,Me.height,he,Re,Me.data):t.texImage2D(i.TEXTURE_2D,H,Le,Me.width,Me.height,0,he,Re,Me.data)}else if(x.isDataArrayTexture)if(Oe){if(it&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,Le,re.width,re.height,re.depth),D)if(x.layerUpdates.size>0){const H=rl(re.width,re.height,x.format,x.type);for(const Q of x.layerUpdates){const fe=re.data.subarray(Q*H/re.data.BYTES_PER_ELEMENT,(Q+1)*H/re.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Q,re.width,re.height,1,he,Re,fe)}x.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,he,Re,re.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Le,re.width,re.height,re.depth,0,he,Re,re.data);else if(x.isData3DTexture)Oe?(it&&t.texStorage3D(i.TEXTURE_3D,pe,Le,re.width,re.height,re.depth),D&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,he,Re,re.data)):t.texImage3D(i.TEXTURE_3D,0,Le,re.width,re.height,re.depth,0,he,Re,re.data);else if(x.isFramebufferTexture){if(it)if(Oe)t.texStorage2D(i.TEXTURE_2D,pe,Le,re.width,re.height);else{let H=re.width,Q=re.height;for(let fe=0;fe<pe;fe++)t.texImage2D(i.TEXTURE_2D,fe,Le,H,Q,0,he,Re,null),H>>=1,Q>>=1}}else if(qe.length>0){if(Oe&&it){const H=Ue(qe[0]);t.texStorage2D(i.TEXTURE_2D,pe,Le,H.width,H.height)}for(let H=0,Q=qe.length;H<Q;H++)Me=qe[H],Oe?D&&t.texSubImage2D(i.TEXTURE_2D,H,0,0,he,Re,Me):t.texImage2D(i.TEXTURE_2D,H,Le,he,Re,Me);x.generateMipmaps=!1}else if(Oe){if(it){const H=Ue(re);t.texStorage2D(i.TEXTURE_2D,pe,Le,H.width,H.height)}D&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,he,Re,re)}else t.texImage2D(i.TEXTURE_2D,0,Le,he,Re,re);d(x)&&u($),Te.__version=j.version,x.onUpdate&&x.onUpdate(x)}b.__version=x.version}function K(b,x,k){if(x.image.length!==6)return;const $=Ge(b,x),ie=x.source;t.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+k);const j=n.get(ie);if(ie.version!==j.__version||$===!0){t.activeTexture(i.TEXTURE0+k);const Te=nt.getPrimaries(nt.workingColorSpace),oe=x.colorSpace===wn?null:nt.getPrimaries(x.colorSpace),xe=x.colorSpace===wn||Te===oe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);const ze=x.isCompressedTexture||x.image[0].isCompressedTexture,re=x.image[0]&&x.image[0].isDataTexture,he=[];for(let Q=0;Q<6;Q++)!ze&&!re?he[Q]=M(x.image[Q],!0,s.maxCubemapSize):he[Q]=re?x.image[Q].image:x.image[Q],he[Q]=Ye(x,he[Q]);const Re=he[0],Le=r.convert(x.format,x.colorSpace),Me=r.convert(x.type),qe=E(x.internalFormat,Le,Me,x.colorSpace),Oe=x.isVideoTexture!==!0,it=j.__version===void 0||$===!0,D=ie.dataReady;let pe=T(x,Re);de(i.TEXTURE_CUBE_MAP,x);let H;if(ze){Oe&&it&&t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,qe,Re.width,Re.height);for(let Q=0;Q<6;Q++){H=he[Q].mipmaps;for(let fe=0;fe<H.length;fe++){const ge=H[fe];x.format!==Zt?Le!==null?Oe?D&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe,0,0,ge.width,ge.height,Le,ge.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe,qe,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Oe?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe,0,0,ge.width,ge.height,Le,Me,ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe,qe,ge.width,ge.height,0,Le,Me,ge.data)}}}else{if(H=x.mipmaps,Oe&&it){H.length>0&&pe++;const Q=Ue(he[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,qe,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(re){Oe?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,he[Q].width,he[Q].height,Le,Me,he[Q].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,qe,he[Q].width,he[Q].height,0,Le,Me,he[Q].data);for(let fe=0;fe<H.length;fe++){const Ze=H[fe].image[Q].image;Oe?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe+1,0,0,Ze.width,Ze.height,Le,Me,Ze.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe+1,qe,Ze.width,Ze.height,0,Le,Me,Ze.data)}}else{Oe?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Le,Me,he[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,qe,Le,Me,he[Q]);for(let fe=0;fe<H.length;fe++){const ge=H[fe];Oe?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe+1,0,0,Le,Me,ge.image[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe+1,qe,Le,Me,ge.image[Q])}}}d(x)&&u(i.TEXTURE_CUBE_MAP),j.__version=ie.version,x.onUpdate&&x.onUpdate(x)}b.__version=x.version}function ae(b,x,k,$,ie,j){const Te=r.convert(k.format,k.colorSpace),oe=r.convert(k.type),xe=E(k.internalFormat,Te,oe,k.colorSpace);if(!n.get(x).__hasExternalTextures){const re=Math.max(1,x.width>>j),he=Math.max(1,x.height>>j);ie===i.TEXTURE_3D||ie===i.TEXTURE_2D_ARRAY?t.texImage3D(ie,j,xe,re,he,x.depth,0,Te,oe,null):t.texImage2D(ie,j,xe,re,he,0,Te,oe,null)}t.bindFramebuffer(i.FRAMEBUFFER,b),$e(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,$,ie,n.get(k).__webglTexture,0,We(x)):(ie===i.TEXTURE_2D||ie>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ie<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,$,ie,n.get(k).__webglTexture,j),t.bindFramebuffer(i.FRAMEBUFFER,null)}function be(b,x,k){if(i.bindRenderbuffer(i.RENDERBUFFER,b),x.depthBuffer){const $=x.depthTexture,ie=$&&$.isDepthTexture?$.type:null,j=y(x.stencilBuffer,ie),Te=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=We(x);$e(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,oe,j,x.width,x.height):k?i.renderbufferStorageMultisample(i.RENDERBUFFER,oe,j,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,j,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Te,i.RENDERBUFFER,b)}else{const $=x.textures;for(let ie=0;ie<$.length;ie++){const j=$[ie],Te=r.convert(j.format,j.colorSpace),oe=r.convert(j.type),xe=E(j.internalFormat,Te,oe,j.colorSpace),ze=We(x);k&&$e(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,ze,xe,x.width,x.height):$e(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ze,xe,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,xe,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ye(b,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,b),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),J(x.depthTexture,0);const $=n.get(x.depthTexture).__webglTexture,ie=We(x);if(x.depthTexture.format===Si)$e(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,$,0,ie):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,$,0);else if(x.depthTexture.format===Ci)$e(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,$,0,ie):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function Be(b){const x=n.get(b),k=b.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==b.depthTexture){const $=b.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),$){const ie=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,$.removeEventListener("dispose",ie)};$.addEventListener("dispose",ie),x.__depthDisposeCallback=ie}x.__boundDepthTexture=$}if(b.depthTexture&&!x.__autoAllocateDepthBuffer){if(k)throw new Error("target.depthTexture not supported in Cube render targets");ye(x.__webglFramebuffer,b)}else if(k){x.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[$]),x.__webglDepthbuffer[$]===void 0)x.__webglDepthbuffer[$]=i.createRenderbuffer(),be(x.__webglDepthbuffer[$],b,!1);else{const ie=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,j=x.__webglDepthbuffer[$];i.bindRenderbuffer(i.RENDERBUFFER,j),i.framebufferRenderbuffer(i.FRAMEBUFFER,ie,i.RENDERBUFFER,j)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),be(x.__webglDepthbuffer,b,!1);else{const $=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ie=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ie),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ie)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Pe(b,x,k){const $=n.get(b);x!==void 0&&ae($.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),k!==void 0&&Be(b)}function Xe(b){const x=b.texture,k=n.get(b),$=n.get(x);b.addEventListener("dispose",L);const ie=b.textures,j=b.isWebGLCubeRenderTarget===!0,Te=ie.length>1;if(Te||($.__webglTexture===void 0&&($.__webglTexture=i.createTexture()),$.__version=x.version,a.memory.textures++),j){k.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer[oe]=[];for(let xe=0;xe<x.mipmaps.length;xe++)k.__webglFramebuffer[oe][xe]=i.createFramebuffer()}else k.__webglFramebuffer[oe]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer=[];for(let oe=0;oe<x.mipmaps.length;oe++)k.__webglFramebuffer[oe]=i.createFramebuffer()}else k.__webglFramebuffer=i.createFramebuffer();if(Te)for(let oe=0,xe=ie.length;oe<xe;oe++){const ze=n.get(ie[oe]);ze.__webglTexture===void 0&&(ze.__webglTexture=i.createTexture(),a.memory.textures++)}if(b.samples>0&&$e(b)===!1){k.__webglMultisampledFramebuffer=i.createFramebuffer(),k.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let oe=0;oe<ie.length;oe++){const xe=ie[oe];k.__webglColorRenderbuffer[oe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,k.__webglColorRenderbuffer[oe]);const ze=r.convert(xe.format,xe.colorSpace),re=r.convert(xe.type),he=E(xe.internalFormat,ze,re,xe.colorSpace,b.isXRRenderTarget===!0),Re=We(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,Re,he,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.RENDERBUFFER,k.__webglColorRenderbuffer[oe])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(k.__webglDepthRenderbuffer=i.createRenderbuffer(),be(k.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(j){t.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),de(i.TEXTURE_CUBE_MAP,x);for(let oe=0;oe<6;oe++)if(x.mipmaps&&x.mipmaps.length>0)for(let xe=0;xe<x.mipmaps.length;xe++)ae(k.__webglFramebuffer[oe][xe],b,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,xe);else ae(k.__webglFramebuffer[oe],b,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);d(x)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Te){for(let oe=0,xe=ie.length;oe<xe;oe++){const ze=ie[oe],re=n.get(ze);t.bindTexture(i.TEXTURE_2D,re.__webglTexture),de(i.TEXTURE_2D,ze),ae(k.__webglFramebuffer,b,ze,i.COLOR_ATTACHMENT0+oe,i.TEXTURE_2D,0),d(ze)&&u(i.TEXTURE_2D)}t.unbindTexture()}else{let oe=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(oe=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(oe,$.__webglTexture),de(oe,x),x.mipmaps&&x.mipmaps.length>0)for(let xe=0;xe<x.mipmaps.length;xe++)ae(k.__webglFramebuffer[xe],b,x,i.COLOR_ATTACHMENT0,oe,xe);else ae(k.__webglFramebuffer,b,x,i.COLOR_ATTACHMENT0,oe,0);d(x)&&u(oe),t.unbindTexture()}b.depthBuffer&&Be(b)}function Qe(b){const x=b.textures;for(let k=0,$=x.length;k<$;k++){const ie=x[k];if(d(ie)){const j=b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Te=n.get(ie).__webglTexture;t.bindTexture(j,Te),u(j),t.unbindTexture()}}}const Ve=[],P=[];function bt(b){if(b.samples>0){if($e(b)===!1){const x=b.textures,k=b.width,$=b.height;let ie=i.COLOR_BUFFER_BIT;const j=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Te=n.get(b),oe=x.length>1;if(oe)for(let xe=0;xe<x.length;xe++)t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Te.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Te.__webglFramebuffer);for(let xe=0;xe<x.length;xe++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(ie|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(ie|=i.STENCIL_BUFFER_BIT)),oe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Te.__webglColorRenderbuffer[xe]);const ze=n.get(x[xe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ze,0)}i.blitFramebuffer(0,0,k,$,0,0,k,$,ie,i.NEAREST),l===!0&&(Ve.length=0,P.length=0,Ve.push(i.COLOR_ATTACHMENT0+xe),b.depthBuffer&&b.resolveDepthBuffer===!1&&(Ve.push(j),P.push(j),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,P)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ve))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),oe)for(let xe=0;xe<x.length;xe++){t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.RENDERBUFFER,Te.__webglColorRenderbuffer[xe]);const ze=n.get(x[xe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.TEXTURE_2D,ze,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Te.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const x=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function We(b){return Math.min(s.maxSamples,b.samples)}function $e(b){const x=n.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function Ne(b){const x=a.render.frame;h.get(b)!==x&&(h.set(b,x),b.update())}function Ye(b,x){const k=b.colorSpace,$=b.format,ie=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||k!==Un&&k!==wn&&(nt.getTransfer(k)===lt?($!==Zt||ie!==_n)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",k)),x}function Ue(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=W,this.resetTextureUnits=S,this.setTexture2D=J,this.setTexture2DArray=te,this.setTexture3D=X,this.setTextureCube=ne,this.rebindTextures=Pe,this.setupRenderTarget=Xe,this.updateRenderTargetMipmap=Qe,this.updateMultisampleRenderTarget=bt,this.setupDepthRenderbuffer=Be,this.setupFrameBufferTexture=ae,this.useMultisampledRTT=$e}function wm(i,e){function t(n,s=wn){let r;const a=nt.getTransfer(s);if(n===_n)return i.UNSIGNED_BYTE;if(n===Va)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Wa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Gl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===kl)return i.BYTE;if(n===Hl)return i.SHORT;if(n===ji)return i.UNSIGNED_SHORT;if(n===Ga)return i.INT;if(n===jn)return i.UNSIGNED_INT;if(n===fn)return i.FLOAT;if(n===Ki)return i.HALF_FLOAT;if(n===Vl)return i.ALPHA;if(n===Wl)return i.RGB;if(n===Zt)return i.RGBA;if(n===Xl)return i.LUMINANCE;if(n===Yl)return i.LUMINANCE_ALPHA;if(n===Si)return i.DEPTH_COMPONENT;if(n===Ci)return i.DEPTH_STENCIL;if(n===ql)return i.RED;if(n===Xa)return i.RED_INTEGER;if(n===jl)return i.RG;if(n===Ya)return i.RG_INTEGER;if(n===qa)return i.RGBA_INTEGER;if(n===Ls||n===Ds||n===Is||n===Ns)if(a===lt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ls)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ds)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Is)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ns)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ls)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ds)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Is)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ns)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ha||n===ua||n===da||n===fa)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ha)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ua)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===da)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===fa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===pa||n===ma||n===_a)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===pa||n===ma)return a===lt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===_a)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ga||n===va||n===xa||n===Ma||n===Sa||n===ya||n===Ea||n===ba||n===Ta||n===Aa||n===wa||n===Ra||n===Ca||n===Pa)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ga)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===va)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===xa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ma)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Sa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ya)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ea)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ba)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ta)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Aa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===wa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ra)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ca)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Pa)return a===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Us||n===La||n===Da)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Us)return a===lt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===La)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Da)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Kl||n===Ia||n===Na||n===Ua)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Us)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ia)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Na)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ua)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ri?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class Rm extends kt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Rn extends xt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Cm={type:"move"};class Gr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Rn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Rn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new O,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new O),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Rn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new O,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new O),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const M of e.hand.values()){const d=t.getJointPose(M,n),u=this._getHandJoint(c,M);d!==null&&(u.matrix.fromArray(d.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=d.radius),u.visible=d!==null}const h=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],m=h.position.distanceTo(f.position),p=.02,_=.005;c.inputState.pinching&&m>p+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&m<=p-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Cm)))}return o!==null&&(o.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Rn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Pm=`
void main() {
