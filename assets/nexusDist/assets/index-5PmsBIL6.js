...
`)+`
`+d);const S=b+h+o,A=b+d+a,k=rl(s,s.VERTEX_SHADER,S),L=rl(s,s.FRAGMENT_SHADER,A);s.attachShader(_,k),s.attachShader(_,L),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function C(y){if(i.debug.checkShaderErrors){const X=s.getProgramInfoLog(_).trim(),Y=s.getShaderInfoLog(k).trim(),te=s.getShaderInfoLog(L).trim();let se=!0,K=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(se=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,k,L);else{const ie=ol(s,k,"vertex"),j=ol(s,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
}`;function Rm(i,e,t){let n=new oa;const s=new ze,r=new ze,o=new mt,a=new bm({depthPacking:vu}),l=new Tm,c={},u=t.maxTextureSize,m={[Fn]:Nt,[Nt]:Fn,[mn]:mn},f=new On({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ze},radius:{value:4}},vertexShader:Am,fragmentShader:wm}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const v=new Ht;v.setAttribute("position",new sn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Xt(v,f),h=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Wl;let d=this.type;this.render=function(L,C,O){if(h.enabled===!1||h.autoUpdate===!1&&h.needsUpdate===!1||L.length===0)return;const J=i.getRenderTarget(),g=i.getActiveCubeFace(),y=i.getActiveMipmapLevel(),X=i.state;X.setBlending(Nn),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const Y=d!==pn&&this.type===pn,te=d===pn&&this.type!==pn;for(let se=0,K=L.length;se<K;se++){const ie=L[se],j=ie.shadow;if(j===void 0){console.warn("THREE.WebGLShadowMap:",ie,"has no shadow.");continue}if(j.autoUpdate===!1&&j.needsUpdate===!1)continue;s.copy(j.mapSize);const _e=j.getFrameExtents();if(s.multiply(_e),r.copy(j.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/_e.x),s.x=r.x*_e.x,j.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/_e.y),s.y=r.y*_e.y,j.mapSize.y=r.y)),j.map===null||Y===!0||te===!0){const Te=this.type!==pn?{minFilter:Wt,magFilter:Wt}:{};j.map!==null&&j.map.dispose(),j.map=new Jn(s.x,s.y,Te),j.map.texture.name=ie.name+".shadowMap",j.camera.updateProjectionMatrix()}i.setRenderTarget(j.map),i.clear();const ve=j.getViewportCount();for(let Te=0;Te<ve;Te++){const it=j.getViewport(Te);o.set(r.x*it.x,r.y*it.y,r.x*it.z,r.y*it.w),X.viewport(o),j.updateMatrices(ie,Te),n=j.getFrustum(),A(C,O,j.camera,ie,this.type)}j.isPointLightShadow!==!0&&this.type===pn&&b(j,O),j.needsUpdate=!1}d=this.type,h.needsUpdate=!1,i.setRenderTarget(J,g,y)};function b(L,C){const O=e.update(_);f.defines.VSM_SAMPLES!==L.blurSamples&&(f.defines.VSM_SAMPLES=L.blurSamples,p.defines.VSM_SAMPLES=L.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),L.mapPass===null&&(L.mapPass=new Jn(s.x,s.y)),f.uniforms.shadow_pass.value=L.map.texture,f.uniforms.resolution.value=L.mapSize,f.uniforms.radius.value=L.radius,i.setRenderTarget(L.mapPass),i.clear(),i.renderBufferDirect(C,null,O,f,_,null),p.uniforms.shadow_pass.value=L.mapPass.texture,p.uniforms.resolution.value=L.mapSize,p.uniforms.radius.value=L.radius,i.setRenderTarget(L.map),i.clear(),i.renderBufferDirect(C,null,O,p,_,null)}function S(L,C,O,J){let g=null;const y=O.isPointLight===!0?L.customDistanceMaterial:L.customDepthMaterial;if(y!==void 0)g=y;else if(g=O.isPointLight===!0?l:a,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const X=g.uuid,Y=C.uuid;let te=c[X];te===void 0&&(te={},c[X]=te);let se=te[Y];se===void 0&&(se=g.clone(),te[Y]=se,C.addEventListener("dispose",k)),g=se}if(g.visible=C.visible,g.wireframe=C.wireframe,J===pn?g.side=C.shadowSide!==null?C.shadowSide:C.side:g.side=C.shadowSide!==null?C.shadowSide:m[C.side],g.alphaMap=C.alphaMap,g.alphaTest=C.alphaTest,g.map=C.map,g.clipShadows=C.clipShadows,g.clippingPlanes=C.clippingPlanes,g.clipIntersection=C.clipIntersection,g.displacementMap=C.displacementMap,g.displacementScale=C.displacementScale,g.displacementBias=C.displacementBias,g.wireframeLinewidth=C.wireframeLinewidth,g.linewidth=C.linewidth,O.isPointLight===!0&&g.isMeshDistanceMaterial===!0){const X=i.properties.get(g);X.light=O}return g}function A(L,C,O,J,g){if(L.visible===!1)return;if(L.layers.test(C.layers)&&(L.isMesh||L.isLine||L.isPoints)&&(L.castShadow||L.receiveShadow&&g===pn)&&(!L.frustumCulled||n.intersectsObject(L))){L.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,L.matrixWorld);const Y=e.update(L),te=L.material;if(Array.isArray(te)){const se=Y.groups;for(let K=0,ie=se.length;K<ie;K++){const j=se[K],_e=te[j.materialIndex];if(_e&&_e.visible){const ve=S(L,_e,J,g);L.onBeforeShadow(i,L,C,O,Y,ve,j),i.renderBufferDirect(O,null,Y,ve,L,j),L.onAfterShadow(i,L,C,O,Y,ve,j)}}}else if(te.visible){const se=S(L,te,J,g);L.onBeforeShadow(i,L,C,O,Y,se,null),i.renderBufferDirect(O,null,Y,se,L,null),L.onAfterShadow(i,L,C,O,Y,se,null)}}const X=L.children;for(let Y=0,te=X.length;Y<te;Y++)A(X[Y],C,O,J,g)}function k(L){L.target.removeEventListener("dispose",k);for(const O in c){const J=c[O],g=L.target.uuid;g in J&&(J[g].dispose(),delete J[g])}}}const Cm={[oo]:ao,[lo]:ho,[co]:fo,[Ri]:uo,[ao]:oo,[ho]:lo,[fo]:co,[uo]:Ri};function Pm(i){function e(){let D=!1;const Se=new mt;let W=null;const ee=new mt(0,0,0,0);return{setMask:function(fe){W!==fe&&!D&&(i.colorMask(fe,fe,fe,fe),W=fe)},setLocked:function(fe){D=fe},setClear:function(fe,ge,Ve,pt,yt){yt===!0&&(fe*=pt,ge*=pt,Ve*=pt),Se.set(fe,ge,Ve,pt),ee.equals(Se)===!1&&(i.clearColor(fe,ge,Ve,pt),ee.copy(Se))},reset:function(){D=!1,W=null,ee.set(-1,0,0,0)}}}function t(){let D=!1,Se=!1,W=null,ee=null,fe=null;return{setReversed:function(ge){Se=ge},setTest:function(ge){ge?ye(i.DEPTH_TEST):xe(i.DEPTH_TEST)},setMask:function(ge){W!==ge&&!D&&(i.depthMask(ge),W=ge)},setFunc:function(ge){if(Se&&(ge=Cm[ge]),ee!==ge){switch(ge){case oo:i.depthFunc(i.NEVER);break;case ao:i.depthFunc(i.ALWAYS);break;case lo:i.depthFunc(i.LESS);break;case Ri:i.depthFunc(i.LEQUAL);break;case co:i.depthFunc(i.EQUAL);break;case uo:i.depthFunc(i.GEQUAL);break;case ho:i.depthFunc(i.GREATER);break;case fo:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ee=ge}},setLocked:function(ge){D=ge},setClear:function(ge){fe!==ge&&(i.clearDepth(ge),fe=ge)},reset:function(){D=!1,W=null,ee=null,fe=null}}}function n(){let D=!1,Se=null,W=null,ee=null,fe=null,ge=null,Ve=null,pt=null,yt=null;return{setTest:function(Ke){D||(Ke?ye(i.STENCIL_TEST):xe(i.STENCIL_TEST))},setMask:function(Ke){Se!==Ke&&!D&&(i.stencilMask(Ke),Se=Ke)},setFunc:function(Ke,gt,Ct){(W!==Ke||ee!==gt||fe!==Ct)&&(i.stencilFunc(Ke,gt,Ct),W=Ke,ee=gt,fe=Ct)},setOp:function(Ke,gt,Ct){(ge!==Ke||Ve!==gt||pt!==Ct)&&(i.stencilOp(Ke,gt,Ct),ge=Ke,Ve=gt,pt=Ct)},setLocked:function(Ke){D=Ke},setClear:function(Ke){yt!==Ke&&(i.clearStencil(Ke),yt=Ke)},reset:function(){D=!1,Se=null,W=null,ee=null,fe=null,ge=null,Ve=null,pt=null,yt=null}}}const s=new e,r=new t,o=new n,a=new WeakMap,l=new WeakMap;let c={},u={},m=new WeakMap,f=[],p=null,v=!1,_=null,h=null,d=null,b=null,S=null,A=null,k=null,L=new Je(0,0,0),C=0,O=!1,J=null,g=null,y=null,X=null,Y=null;const te=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let se=!1,K=0;const ie=i.getParameter(i.VERSION);ie.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec(ie)[1]),se=K>=1):ie.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec(ie)[1]),se=K>=2);let j=null,_e={};const ve=i.getParameter(i.SCISSOR_BOX),Te=i.getParameter(i.VIEWPORT),it=new mt().fromArray(ve),tt=new mt().fromArray(Te);function Z(D,Se,W,ee){const fe=new Uint8Array(4),ge=i.createTexture();i.bindTexture(D,ge),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ve=0;Ve<W;Ve++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(Se,0,i.RGBA,1,1,ee,0,i.RGBA,i.UNSIGNED_BYTE,fe):i.texImage2D(Se+Ve,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,fe);return ge}const ne={};ne[i.TEXTURE_2D]=Z(i.TEXTURE_2D,i.TEXTURE_2D,1),ne[i.TEXTURE_CUBE_MAP]=Z(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ne[i.TEXTURE_2D_ARRAY]=Z(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ne[i.TEXTURE_3D]=Z(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),ye(i.DEPTH_TEST),r.setFunc(Ri),We(!1),Ze(Sa),ye(i.CULL_FACE),P(Nn);function ye(D){c[D]!==!0&&(i.enable(D),c[D]=!0)}function xe(D){c[D]!==!1&&(i.disable(D),c[D]=!1)}function He(D,Se){return u[D]!==Se?(i.bindFramebuffer(D,Se),u[D]=Se,D===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=Se),D===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=Se),!0):!1}function Ne(D,Se){let W=f,ee=!1;if(D){W=m.get(Se),W===void 0&&(W=[],m.set(Se,W));const fe=D.textures;if(W.length!==fe.length||W[0]!==i.COLOR_ATTACHMENT0){for(let ge=0,Ve=fe.length;ge<Ve;ge++)W[ge]=i.COLOR_ATTACHMENT0+ge;W.length=fe.length,ee=!0}}else W[0]!==i.BACK&&(W[0]=i.BACK,ee=!0);ee&&i.drawBuffers(W)}function Qe(D){return p!==D?(i.useProgram(D),p=D,!0):!1}const rt={[qn]:i.FUNC_ADD,[Wc]:i.FUNC_SUBTRACT,[Xc]:i.FUNC_REVERSE_SUBTRACT};rt[Yc]=i.MIN,rt[qc]=i.MAX;const et={[jc]:i.ZERO,[$c]:i.ONE,[Kc]:i.SRC_COLOR,[so]:i.SRC_ALPHA,[nu]:i.SRC_ALPHA_SATURATE,[eu]:i.DST_COLOR,[Jc]:i.DST_ALPHA,[Zc]:i.ONE_MINUS_SRC_COLOR,[ro]:i.ONE_MINUS_SRC_ALPHA,[tu]:i.ONE_MINUS_DST_COLOR,[Qc]:i.ONE_MINUS_DST_ALPHA,[iu]:i.CONSTANT_COLOR,[su]:i.ONE_MINUS_CONSTANT_COLOR,[ru]:i.CONSTANT_ALPHA,[ou]:i.ONE_MINUS_CONSTANT_ALPHA};function P(D,Se,W,ee,fe,ge,Ve,pt,yt,Ke){if(D===Nn){v===!0&&(xe(i.BLEND),v=!1);return}if(v===!1&&(ye(i.BLEND),v=!0),D!==Vc){if(D!==_||Ke!==O){if((h!==qn||S!==qn)&&(i.blendEquation(i.FUNC_ADD),h=qn,S=qn),Ke)switch(D){case Ei:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ya:i.blendFunc(i.ONE,i.ONE);break;case Ea:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ba:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case Ei:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ya:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Ea:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ba:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}d=null,b=null,A=null,k=null,L.set(0,0,0),C=0,_=D,O=Ke}return}fe=fe||Se,ge=ge||W,Ve=Ve||ee,(Se!==h||fe!==S)&&(i.blendEquationSeparate(rt[Se],rt[fe]),h=Se,S=fe),(W!==d||ee!==b||ge!==A||Ve!==k)&&(i.blendFuncSeparate(et[W],et[ee],et[ge],et[Ve]),d=W,b=ee,A=ge,k=Ve),(pt.equals(L)===!1||yt!==C)&&(i.blendColor(pt.r,pt.g,pt.b,yt),L.copy(pt),C=yt),_=D,O=!1}function Tt(D,Se){D.side===mn?xe(i.CULL_FACE):ye(i.CULL_FACE);let W=D.side===Nt;Se&&(W=!W),We(W),D.blending===Ei&&D.transparent===!1?P(Nn):P(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),r.setFunc(D.depthFunc),r.setTest(D.depthTest),r.setMask(D.depthWrite),s.setMask(D.colorWrite);const ee=D.stencilWrite;o.setTest(ee),ee&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),ct(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ye(i.SAMPLE_ALPHA_TO_COVERAGE):xe(i.SAMPLE_ALPHA_TO_COVERAGE)}function We(D){J!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),J=D)}function Ze(D){D!==kc?(ye(i.CULL_FACE),D!==g&&(D===Sa?i.cullFace(i.BACK):D===Hc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):xe(i.CULL_FACE),g=D}function Ue(D){D!==y&&(se&&i.lineWidth(D),y=D)}function ct(D,Se,W){D?(ye(i.POLYGON_OFFSET_FILL),(X!==Se||Y!==W)&&(i.polygonOffset(Se,W),X=Se,Y=W)):xe(i.POLYGON_OFFSET_FILL)}function Oe(D){D?ye(i.SCISSOR_TEST):xe(i.SCISSOR_TEST)}function w(D){D===void 0&&(D=i.TEXTURE0+te-1),j!==D&&(i.activeTexture(D),j=D)}function x(D,Se,W){W===void 0&&(j===null?W=i.TEXTURE0+te-1:W=j);let ee=_e[W];ee===void 0&&(ee={type:void 0,texture:void 0},_e[W]=ee),(ee.type!==D||ee.texture!==Se)&&(j!==W&&(i.activeTexture(W),j=W),i.bindTexture(D,Se||ne[D]),ee.type=D,ee.texture=Se)}function z(){const D=_e[j];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function Q(){try{i.compressedTexImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function re(){try{i.compressedTexImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function q(){try{i.texSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ae(){try{i.texSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function de(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ee(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function $e(){try{i.texStorage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function le(){try{i.texStorage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function he(){try{i.texImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function De(){try{i.texImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Le(D){it.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),it.copy(D))}function Me(D){tt.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),tt.copy(D))}function Ge(D,Se){let W=l.get(Se);W===void 0&&(W=new WeakMap,l.set(Se,W));let ee=W.get(D);ee===void 0&&(ee=i.getUniformBlockIndex(Se,D.name),W.set(D,ee))}function Be(D,Se){const ee=l.get(Se).get(D);a.get(Se)!==ee&&(i.uniformBlockBinding(Se,ee,D.__bindingPointIndex),a.set(Se,ee))}function at(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},j=null,_e={},u={},m=new WeakMap,f=[],p=null,v=!1,_=null,h=null,d=null,b=null,S=null,A=null,k=null,L=new Je(0,0,0),C=0,O=!1,J=null,g=null,y=null,X=null,Y=null,it.set(0,0,i.canvas.width,i.canvas.height),tt.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:ye,disable:xe,bindFramebuffer:He,drawBuffers:Ne,useProgram:Qe,setBlending:P,setMaterial:Tt,setFlipSided:We,setCullFace:Ze,setLineWidth:Ue,setPolygonOffset:ct,setScissorTest:Oe,activeTexture:w,bindTexture:x,unbindTexture:z,compressedTexImage2D:Q,compressedTexImage3D:re,texImage2D:he,texImage3D:De,updateUBOMapping:Ge,uniformBlockBinding:Be,texStorage2D:$e,texStorage3D:le,texSubImage2D:q,texSubImage3D:Ae,compressedTexSubImage2D:de,compressedTexSubImage3D:Ee,scissor:Le,viewport:Me,reset:at}}function pl(i,e,t,n){const s=Lm(n);switch(t){case Kl:return i*e;case Jl:return i*e;case Ql:return i*e*2;case ec:return i*e/s.components*s.byteLength;case ea:return i*e/s.components*s.byteLength;case tc:return i*e*2/s.components*s.byteLength;case ta:return i*e*2/s.components*s.byteLength;case Zl:return i*e*3/s.components*s.byteLength;case Jt:return i*e*4/s.components*s.byteLength;case na:return i*e*4/s.components*s.byteLength;case ks:case Hs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Gs:case Vs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case xo:case So:return Math.max(i,16)*Math.max(e,8)/4;case vo:case Mo:return Math.max(i,8)*Math.max(e,8)/2;case yo:case Eo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case bo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case To:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ao:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case wo:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Ro:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case Co:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case Po:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case Lo:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case Do:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Io:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case No:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case Uo:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case Fo:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Oo:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case Bo:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Ws:case zo:case ko:return Math.ceil(i/4)*Math.ceil(e/4)*16;case nc:case Ho:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Go:case Vo:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Lm(i){switch(i){case xn:case ql:return{byteLength:1,components:1};case Ji:case jl:case Qi:return{byteLength:2,components:1};case Jo:case Qo:return{byteLength:2,components:4};case Zn:case Zo:case _n:return{byteLength:4,components:1};case $l:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Dm(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ze,u=new WeakMap;let m;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(w,x){return p?new OffscreenCanvas(w,x):er("canvas")}function _(w,x,z){let Q=1;const re=Oe(w);if((re.width>z||re.height>z)&&(Q=z/Math.max(re.width,re.height)),Q<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const q=Math.floor(Q*re.width),Ae=Math.floor(Q*re.height);m===void 0&&(m=v(q,Ae));const de=x?v(q,Ae):m;return de.width=q,de.height=Ae,de.getContext("2d").drawImage(w,0,0,q,Ae),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+re.width+"x"+re.height+") to ("+q+"x"+Ae+")."),de}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+re.width+"x"+re.height+")."),w;return w}function h(w){return w.generateMipmaps&&w.minFilter!==Wt&&w.minFilter!==Kt}function d(w){i.generateMipmap(w)}function b(w,x,z,Q,re=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let q=x;if(x===i.RED&&(z===i.FLOAT&&(q=i.R32F),z===i.HALF_FLOAT&&(q=i.R16F),z===i.UNSIGNED_BYTE&&(q=i.R8)),x===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(q=i.R8UI),z===i.UNSIGNED_SHORT&&(q=i.R16UI),z===i.UNSIGNED_INT&&(q=i.R32UI),z===i.BYTE&&(q=i.R8I),z===i.SHORT&&(q=i.R16I),z===i.INT&&(q=i.R32I)),x===i.RG&&(z===i.FLOAT&&(q=i.RG32F),z===i.HALF_FLOAT&&(q=i.RG16F),z===i.UNSIGNED_BYTE&&(q=i.RG8)),x===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(q=i.RG8UI),z===i.UNSIGNED_SHORT&&(q=i.RG16UI),z===i.UNSIGNED_INT&&(q=i.RG32UI),z===i.BYTE&&(q=i.RG8I),z===i.SHORT&&(q=i.RG16I),z===i.INT&&(q=i.RG32I)),x===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&(q=i.RGB8UI),z===i.UNSIGNED_SHORT&&(q=i.RGB16UI),z===i.UNSIGNED_INT&&(q=i.RGB32UI),z===i.BYTE&&(q=i.RGB8I),z===i.SHORT&&(q=i.RGB16I),z===i.INT&&(q=i.RGB32I)),x===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),z===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),z===i.UNSIGNED_INT&&(q=i.RGBA32UI),z===i.BYTE&&(q=i.RGBA8I),z===i.SHORT&&(q=i.RGBA16I),z===i.INT&&(q=i.RGBA32I)),x===i.RGB&&z===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),x===i.RGBA){const Ae=re?Ks:ot.getTransfer(Q);z===i.FLOAT&&(q=i.RGBA32F),z===i.HALF_FLOAT&&(q=i.RGBA16F),z===i.UNSIGNED_BYTE&&(q=Ae===dt?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function S(w,x){let z;return w?x===null||x===Zn||x===Li?z=i.DEPTH24_STENCIL8:x===_n?z=i.DEPTH32F_STENCIL8:x===Ji&&(z=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Zn||x===Li?z=i.DEPTH_COMPONENT24:x===_n?z=i.DEPTH_COMPONENT32F:x===Ji&&(z=i.DEPTH_COMPONENT16),z}function A(w,x){return h(w)===!0||w.isFramebufferTexture&&w.minFilter!==Wt&&w.minFilter!==Kt?Math.log2(Math.max(x.width,x.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?x.mipmaps.length:1}function k(w){const x=w.target;x.removeEventListener("dispose",k),C(x),x.isVideoTexture&&u.delete(x)}function L(w){const x=w.target;x.removeEventListener("dispose",L),J(x)}function C(w){const x=n.get(w);if(x.__webglInit===void 0)return;const z=w.source,Q=f.get(z);if(Q){const re=Q[x.__cacheKey];re.usedTimes--,re.usedTimes===0&&O(w),Object.keys(Q).length===0&&f.delete(z)}n.remove(w)}function O(w){const x=n.get(w);i.deleteTexture(x.__webglTexture);const z=w.source,Q=f.get(z);delete Q[x.__cacheKey],o.memory.textures--}function J(w){const x=n.get(w);if(w.depthTexture&&w.depthTexture.dispose(),w.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(x.__webglFramebuffer[Q]))for(let re=0;re<x.__webglFramebuffer[Q].length;re++)i.deleteFramebuffer(x.__webglFramebuffer[Q][re]);else i.deleteFramebuffer(x.__webglFramebuffer[Q]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[Q])}else{if(Array.isArray(x.__webglFramebuffer))for(let Q=0;Q<x.__webglFramebuffer.length;Q++)i.deleteFramebuffer(x.__webglFramebuffer[Q]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let Q=0;Q<x.__webglColorRenderbuffer.length;Q++)x.__webglColorRenderbuffer[Q]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[Q]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const z=w.textures;for(let Q=0,re=z.length;Q<re;Q++){const q=n.get(z[Q]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),o.memory.textures--),n.remove(z[Q])}n.remove(w)}let g=0;function y(){g=0}function X(){const w=g;return w>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+s.maxTextures),g+=1,w}function Y(w){const x=[];return x.push(w.wrapS),x.push(w.wrapT),x.push(w.wrapR||0),x.push(w.magFilter),x.push(w.minFilter),x.push(w.anisotropy),x.push(w.internalFormat),x.push(w.format),x.push(w.type),x.push(w.generateMipmaps),x.push(w.premultiplyAlpha),x.push(w.flipY),x.push(w.unpackAlignment),x.push(w.colorSpace),x.join()}function te(w,x){const z=n.get(w);if(w.isVideoTexture&&Ue(w),w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){const Q=w.image;if(Q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{tt(z,w,x);return}}t.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+x)}function se(w,x){const z=n.get(w);if(w.version>0&&z.__version!==w.version){tt(z,w,x);return}t.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+x)}function K(w,x){const z=n.get(w);if(w.version>0&&z.__version!==w.version){tt(z,w,x);return}t.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+x)}function ie(w,x){const z=n.get(w);if(w.version>0&&z.__version!==w.version){Z(z,w,x);return}t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+x)}const j={[_o]:i.REPEAT,[$n]:i.CLAMP_TO_EDGE,[go]:i.MIRRORED_REPEAT},_e={[Wt]:i.NEAREST,[_u]:i.NEAREST_MIPMAP_NEAREST,[ds]:i.NEAREST_MIPMAP_LINEAR,[Kt]:i.LINEAR,[xr]:i.LINEAR_MIPMAP_NEAREST,[Kn]:i.LINEAR_MIPMAP_LINEAR},ve={[Mu]:i.NEVER,[Au]:i.ALWAYS,[Su]:i.LESS,[sc]:i.LEQUAL,[yu]:i.EQUAL,[Tu]:i.GEQUAL,[Eu]:i.GREATER,[bu]:i.NOTEQUAL};function Te(w,x){if(x.type===_n&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===Kt||x.magFilter===xr||x.magFilter===ds||x.magFilter===Kn||x.minFilter===Kt||x.minFilter===xr||x.minFilter===ds||x.minFilter===Kn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,j[x.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,j[x.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,j[x.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,_e[x.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,_e[x.minFilter]),x.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,ve[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Wt||x.minFilter!==ds&&x.minFilter!==Kn||x.type===_n&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");i.texParameterf(w,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function it(w,x){let z=!1;w.__webglInit===void 0&&(w.__webglInit=!0,x.addEventListener("dispose",k));const Q=x.source;let re=f.get(Q);re===void 0&&(re={},f.set(Q,re));const q=Y(x);if(q!==w.__cacheKey){re[q]===void 0&&(re[q]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,z=!0),re[q].usedTimes++;const Ae=re[w.__cacheKey];Ae!==void 0&&(re[w.__cacheKey].usedTimes--,Ae.usedTimes===0&&O(x)),w.__cacheKey=q,w.__webglTexture=re[q].texture}return z}function tt(w,x,z){let Q=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(Q=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(Q=i.TEXTURE_3D);const re=it(w,x),q=x.source;t.bindTexture(Q,w.__webglTexture,i.TEXTURE0+z);const Ae=n.get(q);if(q.version!==Ae.__version||re===!0){t.activeTexture(i.TEXTURE0+z);const de=ot.getPrimaries(ot.workingColorSpace),Ee=x.colorSpace===Ln?null:ot.getPrimaries(x.colorSpace),$e=x.colorSpace===Ln||de===Ee?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,$e);let le=_(x.image,!1,s.maxTextureSize);le=ct(x,le);const he=r.convert(x.format,x.colorSpace),De=r.convert(x.type);let Le=b(x.internalFormat,he,De,x.colorSpace,x.isVideoTexture);Te(Q,x);let Me;const Ge=x.mipmaps,Be=x.isVideoTexture!==!0,at=Ae.__version===void 0||re===!0,D=q.dataReady,Se=A(x,le);if(x.isDepthTexture)Le=S(x.format===Di,x.type),at&&(Be?t.texStorage2D(i.TEXTURE_2D,1,Le,le.width,le.height):t.texImage2D(i.TEXTURE_2D,0,Le,le.width,le.height,0,he,De,null));else if(x.isDataTexture)if(Ge.length>0){Be&&at&&t.texStorage2D(i.TEXTURE_2D,Se,Le,Ge[0].width,Ge[0].height);for(let W=0,ee=Ge.length;W<ee;W++)Me=Ge[W],Be?D&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,Me.width,Me.height,he,De,Me.data):t.texImage2D(i.TEXTURE_2D,W,Le,Me.width,Me.height,0,he,De,Me.data);x.generateMipmaps=!1}else Be?(at&&t.texStorage2D(i.TEXTURE_2D,Se,Le,le.width,le.height),D&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,le.width,le.height,he,De,le.data)):t.texImage2D(i.TEXTURE_2D,0,Le,le.width,le.height,0,he,De,le.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Be&&at&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Se,Le,Ge[0].width,Ge[0].height,le.depth);for(let W=0,ee=Ge.length;W<ee;W++)if(Me=Ge[W],x.format!==Jt)if(he!==null)if(Be){if(D)if(x.layerUpdates.size>0){const fe=pl(Me.width,Me.height,x.format,x.type);for(const ge of x.layerUpdates){const Ve=Me.data.subarray(ge*fe/Me.data.BYTES_PER_ELEMENT,(ge+1)*fe/Me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,ge,Me.width,Me.height,1,he,Ve,0,0)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,Me.width,Me.height,le.depth,he,Me.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,W,Le,Me.width,Me.height,le.depth,0,Me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Be?D&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,Me.width,Me.height,le.depth,he,De,Me.data):t.texImage3D(i.TEXTURE_2D_ARRAY,W,Le,Me.width,Me.height,le.depth,0,he,De,Me.data)}else{Be&&at&&t.texStorage2D(i.TEXTURE_2D,Se,Le,Ge[0].width,Ge[0].height);for(let W=0,ee=Ge.length;W<ee;W++)Me=Ge[W],x.format!==Jt?he!==null?Be?D&&t.compressedTexSubImage2D(i.TEXTURE_2D,W,0,0,Me.width,Me.height,he,Me.data):t.compressedTexImage2D(i.TEXTURE_2D,W,Le,Me.width,Me.height,0,Me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Be?D&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,Me.width,Me.height,he,De,Me.data):t.texImage2D(i.TEXTURE_2D,W,Le,Me.width,Me.height,0,he,De,Me.data)}else if(x.isDataArrayTexture)if(Be){if(at&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Se,Le,le.width,le.height,le.depth),D)if(x.layerUpdates.size>0){const W=pl(le.width,le.height,x.format,x.type);for(const ee of x.layerUpdates){const fe=le.data.subarray(ee*W/le.data.BYTES_PER_ELEMENT,(ee+1)*W/le.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ee,le.width,le.height,1,he,De,fe)}x.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,le.width,le.height,le.depth,he,De,le.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Le,le.width,le.height,le.depth,0,he,De,le.data);else if(x.isData3DTexture)Be?(at&&t.texStorage3D(i.TEXTURE_3D,Se,Le,le.width,le.height,le.depth),D&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,le.width,le.height,le.depth,he,De,le.data)):t.texImage3D(i.TEXTURE_3D,0,Le,le.width,le.height,le.depth,0,he,De,le.data);else if(x.isFramebufferTexture){if(at)if(Be)t.texStorage2D(i.TEXTURE_2D,Se,Le,le.width,le.height);else{let W=le.width,ee=le.height;for(let fe=0;fe<Se;fe++)t.texImage2D(i.TEXTURE_2D,fe,Le,W,ee,0,he,De,null),W>>=1,ee>>=1}}else if(Ge.length>0){if(Be&&at){const W=Oe(Ge[0]);t.texStorage2D(i.TEXTURE_2D,Se,Le,W.width,W.height)}for(let W=0,ee=Ge.length;W<ee;W++)Me=Ge[W],Be?D&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,he,De,Me):t.texImage2D(i.TEXTURE_2D,W,Le,he,De,Me);x.generateMipmaps=!1}else if(Be){if(at){const W=Oe(le);t.texStorage2D(i.TEXTURE_2D,Se,Le,W.width,W.height)}D&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,he,De,le)}else t.texImage2D(i.TEXTURE_2D,0,Le,he,De,le);h(x)&&d(Q),Ae.__version=q.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function Z(w,x,z){if(x.image.length!==6)return;const Q=it(w,x),re=x.source;t.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+z);const q=n.get(re);if(re.version!==q.__version||Q===!0){t.activeTexture(i.TEXTURE0+z);const Ae=ot.getPrimaries(ot.workingColorSpace),de=x.colorSpace===Ln?null:ot.getPrimaries(x.colorSpace),Ee=x.colorSpace===Ln||Ae===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const $e=x.isCompressedTexture||x.image[0].isCompressedTexture,le=x.image[0]&&x.image[0].isDataTexture,he=[];for(let ee=0;ee<6;ee++)!$e&&!le?he[ee]=_(x.image[ee],!0,s.maxCubemapSize):he[ee]=le?x.image[ee].image:x.image[ee],he[ee]=ct(x,he[ee]);const De=he[0],Le=r.convert(x.format,x.colorSpace),Me=r.convert(x.type),Ge=b(x.internalFormat,Le,Me,x.colorSpace),Be=x.isVideoTexture!==!0,at=q.__version===void 0||Q===!0,D=re.dataReady;let Se=A(x,De);Te(i.TEXTURE_CUBE_MAP,x);let W;if($e){Be&&at&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Se,Ge,De.width,De.height);for(let ee=0;ee<6;ee++){W=he[ee].mipmaps;for(let fe=0;fe<W.length;fe++){const ge=W[fe];x.format!==Jt?Le!==null?Be?D&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,fe,0,0,ge.width,ge.height,Le,ge.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,fe,Ge,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Be?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,fe,0,0,ge.width,ge.height,Le,Me,ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,fe,Ge,ge.width,ge.height,0,Le,Me,ge.data)}}}else{if(W=x.mipmaps,Be&&at){W.length>0&&Se++;const ee=Oe(he[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,Se,Ge,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(le){Be?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,he[ee].width,he[ee].height,Le,Me,he[ee].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ge,he[ee].width,he[ee].height,0,Le,Me,he[ee].data);for(let fe=0;fe<W.length;fe++){const Ve=W[fe].image[ee].image;Be?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,fe+1,0,0,Ve.width,Ve.height,Le,Me,Ve.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,fe+1,Ge,Ve.width,Ve.height,0,Le,Me,Ve.data)}}else{Be?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Le,Me,he[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ge,Le,Me,he[ee]);for(let fe=0;fe<W.length;fe++){const ge=W[fe];Be?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,fe+1,0,0,Le,Me,ge.image[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,fe+1,Ge,Le,Me,ge.image[ee])}}}h(x)&&d(i.TEXTURE_CUBE_MAP),q.__version=re.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function ne(w,x,z,Q,re,q){const Ae=r.convert(z.format,z.colorSpace),de=r.convert(z.type),Ee=b(z.internalFormat,Ae,de,z.colorSpace);if(!n.get(x).__hasExternalTextures){const le=Math.max(1,x.width>>q),he=Math.max(1,x.height>>q);re===i.TEXTURE_3D||re===i.TEXTURE_2D_ARRAY?t.texImage3D(re,q,Ee,le,he,x.depth,0,Ae,de,null):t.texImage2D(re,q,Ee,le,he,0,Ae,de,null)}t.bindFramebuffer(i.FRAMEBUFFER,w),Ze(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,re,n.get(z).__webglTexture,0,We(x)):(re===i.TEXTURE_2D||re>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&re<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Q,re,n.get(z).__webglTexture,q),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ye(w,x,z){if(i.bindRenderbuffer(i.RENDERBUFFER,w),x.depthBuffer){const Q=x.depthTexture,re=Q&&Q.isDepthTexture?Q.type:null,q=S(x.stencilBuffer,re),Ae=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=We(x);Ze(x)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,de,q,x.width,x.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,de,q,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,q,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Ae,i.RENDERBUFFER,w)}else{const Q=x.textures;for(let re=0;re<Q.length;re++){const q=Q[re],Ae=r.convert(q.format,q.colorSpace),de=r.convert(q.type),Ee=b(q.internalFormat,Ae,de,q.colorSpace),$e=We(x);z&&Ze(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,$e,Ee,x.width,x.height):Ze(x)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,$e,Ee,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,Ee,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function xe(w,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,w),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),te(x.depthTexture,0);const Q=n.get(x.depthTexture).__webglTexture,re=We(x);if(x.depthTexture.format===bi)Ze(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Q,0,re):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Q,0);else if(x.depthTexture.format===Di)Ze(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Q,0,re):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Q,0);else throw new Error("Unknown depthTexture format")}function He(w){const x=n.get(w),z=w.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==w.depthTexture){const Q=w.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),Q){const re=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,Q.removeEventListener("dispose",re)};Q.addEventListener("dispose",re),x.__depthDisposeCallback=re}x.__boundDepthTexture=Q}if(w.depthTexture&&!x.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");xe(x.__webglFramebuffer,w)}else if(z){x.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)if(t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[Q]),x.__webglDepthbuffer[Q]===void 0)x.__webglDepthbuffer[Q]=i.createRenderbuffer(),ye(x.__webglDepthbuffer[Q],w,!1);else{const re=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=x.__webglDepthbuffer[Q];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,re,i.RENDERBUFFER,q)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),ye(x.__webglDepthbuffer,w,!1);else{const Q=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,re),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,re)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ne(w,x,z){const Q=n.get(w);x!==void 0&&ne(Q.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&He(w)}function Qe(w){const x=w.texture,z=n.get(w),Q=n.get(x);w.addEventListener("dispose",L);const re=w.textures,q=w.isWebGLCubeRenderTarget===!0,Ae=re.length>1;if(Ae||(Q.__webglTexture===void 0&&(Q.__webglTexture=i.createTexture()),Q.__version=x.version,o.memory.textures++),q){z.__webglFramebuffer=[];for(let de=0;de<6;de++)if(x.mipmaps&&x.mipmaps.length>0){z.__webglFramebuffer[de]=[];for(let Ee=0;Ee<x.mipmaps.length;Ee++)z.__webglFramebuffer[de][Ee]=i.createFramebuffer()}else z.__webglFramebuffer[de]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){z.__webglFramebuffer=[];for(let de=0;de<x.mipmaps.length;de++)z.__webglFramebuffer[de]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(Ae)for(let de=0,Ee=re.length;de<Ee;de++){const $e=n.get(re[de]);$e.__webglTexture===void 0&&($e.__webglTexture=i.createTexture(),o.memory.textures++)}if(w.samples>0&&Ze(w)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let de=0;de<re.length;de++){const Ee=re[de];z.__webglColorRenderbuffer[de]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[de]);const $e=r.convert(Ee.format,Ee.colorSpace),le=r.convert(Ee.type),he=b(Ee.internalFormat,$e,le,Ee.colorSpace,w.isXRRenderTarget===!0),De=We(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,De,he,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,z.__webglColorRenderbuffer[de])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),ye(z.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){t.bindTexture(i.TEXTURE_CUBE_MAP,Q.__webglTexture),Te(i.TEXTURE_CUBE_MAP,x);for(let de=0;de<6;de++)if(x.mipmaps&&x.mipmaps.length>0)for(let Ee=0;Ee<x.mipmaps.length;Ee++)ne(z.__webglFramebuffer[de][Ee],w,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ee);else ne(z.__webglFramebuffer[de],w,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);h(x)&&d(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ae){for(let de=0,Ee=re.length;de<Ee;de++){const $e=re[de],le=n.get($e);t.bindTexture(i.TEXTURE_2D,le.__webglTexture),Te(i.TEXTURE_2D,$e),ne(z.__webglFramebuffer,w,$e,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,0),h($e)&&d(i.TEXTURE_2D)}t.unbindTexture()}else{let de=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(de=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(de,Q.__webglTexture),Te(de,x),x.mipmaps&&x.mipmaps.length>0)for(let Ee=0;Ee<x.mipmaps.length;Ee++)ne(z.__webglFramebuffer[Ee],w,x,i.COLOR_ATTACHMENT0,de,Ee);else ne(z.__webglFramebuffer,w,x,i.COLOR_ATTACHMENT0,de,0);h(x)&&d(de),t.unbindTexture()}w.depthBuffer&&He(w)}function rt(w){const x=w.textures;for(let z=0,Q=x.length;z<Q;z++){const re=x[z];if(h(re)){const q=w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Ae=n.get(re).__webglTexture;t.bindTexture(q,Ae),d(q),t.unbindTexture()}}}const et=[],P=[];function Tt(w){if(w.samples>0){if(Ze(w)===!1){const x=w.textures,z=w.width,Q=w.height;let re=i.COLOR_BUFFER_BIT;const q=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ae=n.get(w),de=x.length>1;if(de)for(let Ee=0;Ee<x.length;Ee++)t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ae.__webglFramebuffer);for(let Ee=0;Ee<x.length;Ee++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(re|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(re|=i.STENCIL_BUFFER_BIT)),de){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Ae.__webglColorRenderbuffer[Ee]);const $e=n.get(x[Ee]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,$e,0)}i.blitFramebuffer(0,0,z,Q,0,0,z,Q,re,i.NEAREST),l===!0&&(et.length=0,P.length=0,et.push(i.COLOR_ATTACHMENT0+Ee),w.depthBuffer&&w.resolveDepthBuffer===!1&&(et.push(q),P.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,P)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,et))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),de)for(let Ee=0;Ee<x.length;Ee++){t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,Ae.__webglColorRenderbuffer[Ee]);const $e=n.get(x[Ee]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,$e,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ae.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const x=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function We(w){return Math.min(s.maxSamples,w.samples)}function Ze(w){const x=n.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function Ue(w){const x=o.render.frame;u.get(w)!==x&&(u.set(w,x),w.update())}function ct(w,x){const z=w.colorSpace,Q=w.format,re=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||z!==Bn&&z!==Ln&&(ot.getTransfer(z)===dt?(Q!==Jt||re!==xn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),x}function Oe(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=X,this.resetTextureUnits=y,this.setTexture2D=te,this.setTexture2DArray=se,this.setTexture3D=K,this.setTextureCube=ie,this.rebindTextures=Ne,this.setupRenderTarget=Qe,this.updateRenderTargetMipmap=rt,this.updateMultisampleRenderTarget=Tt,this.setupDepthRenderbuffer=He,this.setupFrameBufferTexture=ne,this.useMultisampledRTT=Ze}function Im(i,e){function t(n,s=Ln){let r;const o=ot.getTransfer(s);if(n===xn)return i.UNSIGNED_BYTE;if(n===Jo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Qo)return i.UNSIGNED_SHORT_5_5_5_1;if(n===$l)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===ql)return i.BYTE;if(n===jl)return i.SHORT;if(n===Ji)return i.UNSIGNED_SHORT;if(n===Zo)return i.INT;if(n===Zn)return i.UNSIGNED_INT;if(n===_n)return i.FLOAT;if(n===Qi)return i.HALF_FLOAT;if(n===Kl)return i.ALPHA;if(n===Zl)return i.RGB;if(n===Jt)return i.RGBA;if(n===Jl)return i.LUMINANCE;if(n===Ql)return i.LUMINANCE_ALPHA;if(n===bi)return i.DEPTH_COMPONENT;if(n===Di)return i.DEPTH_STENCIL;if(n===ec)return i.RED;if(n===ea)return i.RED_INTEGER;if(n===tc)return i.RG;if(n===ta)return i.RG_INTEGER;if(n===na)return i.RGBA_INTEGER;if(n===ks||n===Hs||n===Gs||n===Vs)if(o===dt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ks)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Hs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Gs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Vs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ks)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Hs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Gs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Vs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===vo||n===xo||n===Mo||n===So)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===vo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===xo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Mo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===So)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===yo||n===Eo||n===bo)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===yo||n===Eo)return o===dt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===bo)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===To||n===Ao||n===wo||n===Ro||n===Co||n===Po||n===Lo||n===Do||n===Io||n===No||n===Uo||n===Fo||n===Oo||n===Bo)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===To)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ao)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===wo)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ro)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Co)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Po)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Lo)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Do)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Io)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===No)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Uo)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Fo)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Oo)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Bo)return o===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ws||n===zo||n===ko)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ws)return o===dt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===zo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ko)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===nc||n===Ho||n===Go||n===Vo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Ws)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ho)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Go)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Vo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Li?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class Nm extends Vt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Dn extends bt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Um={type:"move"};class jr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Dn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Dn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new B,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new B),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Dn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new B,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new B),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const _ of e.hand.values()){const h=t.getJointPose(_,n),d=this._getHandJoint(c,_);h!==null&&(d.matrix.fromArray(h.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=h.radius),d.visible=h!==null}const u=c.joints["index-finger-tip"],m=c.joints["thumb-tip"],f=u.position.distanceTo(m.position),p=.02,v=.005;c.inputState.pinching&&f>p+v?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=p-v&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Um)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Dn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Fm=`
void main() {
